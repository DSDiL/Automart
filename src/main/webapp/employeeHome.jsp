	    ...
	    <c:choose>
	    	...
	    	<c:when test="${emp.section=='FinancialManagement'}">
	        	...
	        	<br><br><br><br>
	        		...
	        		<button type="button" onclick="document.location.href='#'" name="em" id="submit">Financial Management
	        		</button>
	       		<br><br><br><br>
	    	...
	    	<c:when test="${emp.section=='DeliveryManagement'}">
	        	...
	        	<br><br><br><br>
	       		...
	       		<br><br><br><br>
	        		...
	        		<button type="button" onclick="document.location.href='#'" name="em" id="submit">Delivery Management
	        		</button>
	        	<br><br><br><br>
