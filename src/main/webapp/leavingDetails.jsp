...
<!--Open Content Area-->
			...
			<c:forEach var="app" items="${app}">
				...
				<label>Status</label> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					<input type="text" name="date" id="date" value="${app.status}" readonly><br><br><br>
				...
				<label>Time Period (Days)</label> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<textarea name="date" id="date" readonly>${app.more}</textarea><br><br><br>	
